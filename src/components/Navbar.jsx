      ...
      <NavigationMenuList className="gap-2">
        <NavigationMenuItem>
          <NavigationMenuTrigger className="hover:bg-slate-100 transition-colors">
            <Link href="/reports" className="text-slate-800 font-medium">
              Reports
            </Link>
          </NavigationMenuTrigger>
        </NavigationMenuItem>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className="min-w-[200px] p-2 bg-white rounded-md shadow-lg">
            <div className="flex flex-col gap-2">
              <NavigationMenuLink
                href="/addfamilymember"
                className="text-slate-800 hover:bg-slate-100 px-4 py-2 rounded-sm transition-colors"
              >
                Family Member
              </NavigationMenuLink>
              <NavigationMenuLink
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className="hover:bg-slate-100 transition-colors">
            <Link href="/emails_sent" className="text-slate-800 font-medium">
              Emails
            </Link>
          </NavigationMenuTrigger>
        </NavigationMenuItem>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className="hover:bg-slate-100 transition-colors">
            <Link href="/queries" className="text-slate-800 font-medium">
              Queries
            </Link>
          </NavigationMenuTrigger>
        </NavigationMenuItem>
